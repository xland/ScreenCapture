...
void Lang::load(const std::wstring& l)
{
	...
	if (l == L"en-US") {
		...
		dic = {
			{ L"tray.capScreen", L"Захват экрана" },
			{ L"tray.capLong", L"Длинный скриншот" },
			{ L"tray.capVideo", L"Запись экрана" },
			{ L"tray.setting", L"Настройки" },
			{ L"tray.exit", L"Выход" },
			{ L"tool.rect", L"Прямоугольник" },
			{ L"tool.ellipse", L"Эллипс" },
			{ L"tool.arrow", L"Стрелка" },
			{ L"tool.number", L"Номер" },
			{ L"tool.line", L"Линия" },
			{ L"tool.text", L"Текст" },
			{ L"tool.mosaic", L"Мозаика" },
			{ L"tool.eraser", L"Ластик" },
			{ L"tool.undo", L"Отмена" },
			{ L"tool.redo", L"Повтор" },
			{ L"tool.clipboard", L"Буфер обмена" },
			{ L"tool.save", L"Сохранить" },
			{ L"tool.close", L"Закрыть" },
			{ L"tool.pin", L"Закрепить" },
			{ L"tool.rectFill", L"Заливка прямоугольника" },
			{ L"tool.ellipseFill", L"Заливка эллипса" },
			{ L"tool.arrowFill", L"Заливка стрелки" },
			{ L"tool.numberFill", L"Заливка номера" },
			{ L"tool.semiTransparent", L"Полупрозрачный" },
			{ L"tool.bold", L"Жирный" },
			{ L"tool.italic", L"Курсив" },
			{ L"color.red", L"Красный" },
			{ L"color.yellow", L"Жёлтый" },
			{ L"color.green", L"Зелёный" },
			{ L"color.cyan", L"Голубой" },
			{ L"color.blue", L"Синий" },
			{ L"color.purple", L"Фиолетовый" },
			{ L"color.pink", L"Розовый" },
			{ L"color.black", L"Чёрный" },
			{ L"color.white", L"Белый" },
			{ L"video.stopRecord", L"Остановить запись" },
			{ L"video.outputMp4", L"Экспорт в MP4" },
			{ L"video.outputGif", L"Экспорт в GIF" },
			{ L"video.recordSystem", L"Запись системного звука" },
			{ L"video.recordMic", L"Запись микрофона" },
			{ L"video.startRecord", L"Начать запись" },
			{ L"video.exit", L"Выход" },
			{ L"video.stopClipboard", L"Остановить и копировать в буфер" },
			{ L"video.stopFile", L"Остановить и сохранить в файл" },
			{ L"video.stopExit", L"Остановить и выйти" },
			{ L"setting.title", L"Настройки ScreenCapture" },
			{ L"setting.common", L"Общие" },
			{ L"setting.shortcut", L"Горячие клавиши" },
			{ L"setting.about", L"О программе" },
			{ L"setting.autoStart", L"Запуск при старте:" },
			{ L"setting.showTray", L"Показывать значок в трее:" },
			{ L"setting.language", L"Язык:" },
			{ L"about.version", L"Версия:" },
			{ L"about.project", L"Проект:" },
			{ L"about.author", L"Автор:" },
			{ L"about.wechat", L"WeChat: liulun_007 (нажмите для копирования)" },
			{ L"about.copySuccess", L"Успешно скопировано" },
			{ L"about.sysTip", L"Информация" },
			{ L"shortcut.cap", L"Захват экрана:" },
			{ L"shortcut.long", L"Длинный скриншот:" },
			{ L"shortcut.video", L"Запись экрана:" },
			{ L"shortcut.pressKey", L"Нажмите клавиши..." },
			{ L"long.start", L"Начать" },
			{ L"long.reachedBottom", L"Достигнут нижний край, захват остановлен" },
			{ L"long.tooLong", L"Изображение слишком длинное, захват остановлен" },
			{ L"util.file", L"Файл" },
		};
	}
	else {
